window.addEventListener('load', () => {
    function countdown() {
        const now = Date.now();
        const grad = new Date('2021-12-22T24:00:00').getTime();
        ...
        const countDown = `Gift arriving in ${yearStr}${daysLeft} days, ${hoursLeft} hours, ${minutesLeft} minutes, ${secondsLeft} seconds.`;
